  ...
  return (
    <div className="fixed bottom-6 right-6 max-sm:bottom-4 max-sm:right-4 z-50 max-sm:z-40">
      {!isChatOpen ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-[280px] h-[520px] max-sm:w-full max-sm:h-full max-sm:rounded-none max-sm:fixed max-sm:inset-0 max-sm:pt-[max(3rem,env(safe-area-inset-top))] max-sm:pb-20 flex">
