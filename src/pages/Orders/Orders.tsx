      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-white bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800">
